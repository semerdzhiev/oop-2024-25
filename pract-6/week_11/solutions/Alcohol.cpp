...
Alcohol::Alcohol(std::string name, const int quantity, std::string description, const double price, const ServingType servingType, const double alcoholPercentage)
