...
- FullTimeEmployee
    - unsigned workDays - брой работни дни в месеца
    - double dailySalary - заплащане на работен ден
- PartTimeEmployee
    - unsigned workHours - брой работни часове в месеца
    - double hourlySalary - заплащане на час
 
(По желание) Създайте клас Company, който съдържа масив с произволна дължина от работници и член-функцията double totalSalaries(), която пресмята колко плаща общо фирмата на работниците си всеки месец.
