...
Създайте клас **Library**, който управлява колекция от книги, представени чрез клас Book. Всяка книга има заглавие, автор, жанр, брой страници и година на издаване. Ако е нужното имплементирайте деструктор, копиращ конструктор и оператор за присвояване.
...
### Юнит тестове
Напишете юнит тестове с Catch2, които покриват медоите на класа Library.
